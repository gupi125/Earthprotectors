...
<div id="container" align="center" ><br><br><br>
    <h1>Add Material Type</h1>
        <form name="addM" onsubmit="return checkSubmit()" method="POST" action="materialSave.php">
        
        <label class="form-check-label">Material Name :</label><br> 
        <input type="text" name="materialName" class="form-control" placeholder="Material name" required>
        ...
        <br>
        <label class="form-check-label">Points per Kg :</label><br> 
        <input type="number" name="pointsPerKg" class="form-control" placeholder="Points per Kg" required>
        
        <br>
        <input type="submit" value="addMaterial" class="btn btn-outline-success  btn-sm">
        </form>
        <br>
