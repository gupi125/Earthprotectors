...
<?php echo $profile_data['username'] ?>'s Profile      
    ...
    <h3><?php echo $profile_data['username'] ?>'s Profile</h3>
        <table>
                    <tr>                
                     <td>Name:</td><td><?php echo $profile_data['fullname'] ?></td>   
                    </tr>
                    <tr>                
                    ...
                    <tr>
                        <td>Days of Week:</td><td><?php echo $profile_data['week'] ?></td> 
                    </tr>  
                    <tr>
                        <td>Time From:</td><td><?php echo $profile_data['timeFrom'] ?></td> 
                    </tr>  
                    <tr>
                        <td>Time To:</td><td><?php echo $profile_data['timeTo'] ?></td> 
                    </tr>            
        </table> </div>
