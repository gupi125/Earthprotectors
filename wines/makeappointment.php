  ...
  <div class="site-wrap">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                ...
                <li><a href="#" class="nav-link text-left">Manage Profile</a></li>
  
                <li class="nav-link text-left" border="1px solid black">xinyi</li>
                <li class="nav-link text-left">100</li>
    ...
    <div id="container" align="center">
      ...
      <?php				
          ...
          $showquery = "SELECT materialID, materialName, description, pointsPerKg from material";
        ...
        echo'<table width="1000">';
          ...
          foreach($materialArr as $materialArr){
            ...
            echo'<td><input type="button" name="select" value="Select">';
            echo'</tr>';
          }  
