          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                ...
                <li><a href="maintainMaterial.php" class="nav-link text-left">Maintain Material Type</a></li>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/recycle.jpeg" alt="Image placeholder" class="img-fluid">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="images/reuse.jpeg" alt="Image placeholder" class="img-fluid ">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/reduce.jpeg" alt="Image placeholder" class="img-fluid">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0 col-md-6">
            <div class="post-entry-1">
              <a href="post-single.html"><img src="images/newa1.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 col-md-6">
            <div class="post-entry-1">
              <a href="post-single.html"><img src="images/news2.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 col-md-6">
            <div class="post-entry-1">
              <a href="post-single.html"><img src="images/news3.jpg" alt="Image" class="img-fluid"></a>
